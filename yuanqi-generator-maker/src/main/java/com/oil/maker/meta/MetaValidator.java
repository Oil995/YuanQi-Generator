...
import com.oil.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "走肖");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.oil");
