...
import com.oil.maker.template.enums.FileFilterRangeEnum;
import com.oil.maker.template.enums.FileFilterRuleEnum;
import com.oil.maker.template.model.FileFilterConfig;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "yuanqi-generator-demo/springboot-init";
...
//        String searchStr = "Sum: ";
        ...
        FileFilterConfig fileFilterConfig = FileFilterConfig.builder()   // @Builder 注解使用
