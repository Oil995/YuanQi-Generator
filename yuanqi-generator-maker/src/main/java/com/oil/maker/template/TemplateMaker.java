package com.oil.maker.template;
...
import com.oil.maker.meta.enums.FileGenerateTypeEnum;
import com.oil.maker.meta.enums.FileTypeEnum;
import com.oil.maker.template.model.TemplateMakerConfig;
import com.oil.maker.template.model.TemplateMakerFileConfig;
import com.oil.maker.template.model.TemplateMakerModelConfig;
import com.oil.maker.template.model.TemplateMakerOutputConfig;
...
public class TemplateMaker {
    ...
    public static long makeTemplate(TemplateMakerConfig templateMakerConfig) {
        ...
        return makeTemplate(meta, originProjectPath, templateMakerFileConfig, outputConfig, templateMakerModelConfig, id);
    }
    ...
    public static long makeTemplate(Meta newMeta, String originProjectPath, TemplateMakerFileConfig templateMakerFileConfig,
        ...
        String sourceRootPath = FileUtil.loopFiles(new File(templatePath), 1, null)
                ...
                .findFirst()
                .orElseThrow(RuntimeException::new) // 添加该参数避免上述找不到文件/目录的报错
                .getAbsolutePath();
     ...
     * @return
     */
    private static List<Meta.FileConfig.FileInfo> makerFileTemplates(TemplateMakerFileConfig templateMakerFileConfig,
